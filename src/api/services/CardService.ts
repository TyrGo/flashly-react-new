...
export class CardService {
   ...
   * @throws ApiError
   */
  public postCardsCreateCard(body?: Card): CancelablePromise<Card> {
   ...
   * @throws ApiError
   */
  public postCardsBinUp(cardId: number): CancelablePromise<Message> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public postCardsBinDown(cardId: number): CancelablePromise<Message> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public deleteCardsDeleteCard(cardId: number): CancelablePromise<Message> {
    return this.httpRequest.request({
      method: 'DELETE',
